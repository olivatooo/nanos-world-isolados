...
function CompareWeapon(
    ...
    let e_weapon_a_clip_size = document.getElementById('weapon_a_clip_size');
    ...
    let e_weapon_b_clip_size = document.getElementById('weapon_b_clip_size');
    ...
    e_weapon_a_clip_size.innerHTML = weapon_a_clip_size + ' ';
    ...
    e_weapon_b_clip_size.innerHTML = weapon_b_clip_size + ' ';
    ...
    if (weapon_a_clip_size < weapon_b_clip_size) {
        e_weapon_a_clip_size.innerHTML += green_arrow;
        e_weapon_b_clip_size.innerHTML += red_arrow;
    } else if (weapon_a_clip_size == weapon_b_clip_size) {
        e_weapon_a_clip_size.innerHTML += yellow_square;
        e_weapon_b_clip_size.innerHTML += yellow_square;
    } else {
        e_weapon_b_clip_size.innerHTML += green_arrow;
        e_weapon_a_clip_size.innerHTML += red_arrow;
    }
}
